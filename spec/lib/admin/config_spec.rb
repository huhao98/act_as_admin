...
describe Admin::Config do 

  before :each do
    @config = Admin::Config.new
  end

  it "default page should be a page for default action" do
    @config.default_page.should_not be_nil
    @config.default_page.should be_a(Admin::Builder::Page)
  ...
  it "default query should be a query for index action" do
    ...
    @config.default_query.should be_a(Admin::Builder::Query)
  ...
  it "default form should be a from for both new and edit action" do
    ...
    @config.default_form.should be_a(Admin::Builder::Form)
  ...
  describe "page" do
    ...
    it "should yeild a new page for action other than :default" do
      ...
      @config.pages[:other].should be_a(Admin::Builder::Page)
    end
  ...
  describe "form" do
    ...
    it "should yield a new form for action other than :edit and :new" do
      ...
      @config.forms[:other].should be_a(Admin::Builder::Form)
  ...
  describe "query" do
    ...
    it "should yield a new query for none index action" do
      ...
      @config.queries[:other].should be_a(Admin::Builder::Query)
